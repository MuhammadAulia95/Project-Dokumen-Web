...
<head>
    ...
    <link rel="stylesheet" href="css/inputLainnya.css">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Input Lainnya</h1>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-5">
                            <div class="card shadow mb-4">
                                <div class="kontent" style="padding: 20px;">
                                    <h6>Peraturan : </h6>
                                    <input type="text" placeholder="Masukkan peraturan...">
                                    <hr>

                                    <h6>Tentang : </h6>
                                    <input type="text" placeholder="Masukkan tentang...">
                                    <hr>
