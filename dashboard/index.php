        ...
        <ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #054e6f;">
            ...
            <?php  
                if ($_SESSION['level'] == "Admin") {
                    include 'admin/menu-bar-admin.php';
                }elseif ($_SESSION['level'] == "User Biasa") {
                    include 'user/menu-bar-user.php';
                }else{
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;" src="../assets/img/welcome.jpg" alt="...">
                                    </div>
                                    <p>Selamat Datang di Sistem Aplilasi Arsip (SIAPSIP) KPKNL Pontianak. 
                                        SIAPSIP merupakan aplikasi arsip internal KPKNL Pontianak berbasis web yang masih dalam tahap pengembangan Selamat mengarsip Sobat KaeN</p>
                                </div>
                            </div>
                        </div>
                    </div>
