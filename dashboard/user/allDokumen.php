                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-bordered" style="background-color: #7bd7c2; color: #4f4f4f;">
                                        ...
                                        <tbody>
                                            ...
                                            if (ISSET($_POST['submit1'])){
                                                $cari = $_POST['search1'];
                                                $query2 = "SELECT * FROM dok_penilaian WHERE nomor_laporan LIKE '%$cari%' OR tanggal_laporan LIKE '%$cari%' OR tanggal_penilaian LIKE '%$cari%' OR nama_penilai LIKE '%$cari%' OR objek_penilaian LIKE '%$cari%' OR satuan_kerja LIKE '%$cari%' OR link LIKE '%$cari%'";
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table table-bordered" style="background-color: #7bd7c2; color: #4f4f4f;">
                                            ...
                                            <tbody>
                                                ...
                                                if (ISSET($_POST['submit2'])){
                                                    $cari = $_POST['search2'];
                                                    $query2 = "SELECT * FROM dok_piutang WHERE nomor_registrasi LIKE '%$cari%' OR nama_debitur LIKE '%$cari%' OR nama_penyerah_piutang LIKE '%$cari%' OR tanggal_penyerahan_piutang LIKE '%$cari%' OR jenis_dokumen LIKE '%$cari%' OR jenis_inaktif LIKE '%$cari%' OR link LIKE '%$cari%'";
