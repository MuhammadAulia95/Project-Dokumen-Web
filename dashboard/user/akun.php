                                ...
                                <form action="process-update-akun.php" method="POST">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" name="username" class="form-control" id="inputUsername" value="<?php echo $_SESSION['username'] ?>" pattern="(?=.*[a-z])(?=.*[A-Z]).{5,}" title="Harus berisi setidaknya satu huruf besar dan kecil, dan setidaknya 8 karakter atau lebih" required="">
                                        </div>                                      
                                        <div class="form-group col-md-4">
