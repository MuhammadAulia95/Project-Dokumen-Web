                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card shadow mb-4">
                            <div class="card-header py-3">
                                <h6 class="m-0 font-weight-bold text-gray">Update Akun</h6>
                            </div>
                            <div class="card-body"> 
                                <form action="process-update-akun.php" method="POST">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <input type="hidden" name="id" value="<?php echo $_SESSION['id'] ?>">
                                            <label for="inputNama">Nama</label>
                                            <input type="text" name="nama" class="form-control" id="inputNama" value="<?php echo $_SESSION['nama'] ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputEmail">Email</label>
                                            <input type="text" name="email" class="form-control" id="inputEmail" disabled="" value="<?php echo $_SESSION['email'] ?>">
                                        </div>
                                    </div>  
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            <label for="inputPassword">Username</label>
                                            <input type="text" name="username" class="form-control" id="inputPassword" value="<?php echo $_SESSION['username'] ?>" pattern="(?=.*[a-z])(?=.*[A-Z]).{5,}" title="Harus berisi setidaknya satu huruf besar dan kecil, dan setidaknya 8 karakter atau lebih" required="">
                                        </div>                                      
                                        <div class="form-group col-md-4">
                                            <label for="inputPassword">Password</label>
                                            <input type="text" name="password" class="form-control" id="inputPassword" value="<?php echo $_SESSION['password'] ?>" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Harus berisi setidaknya satu angka dan satu huruf besar dan kecil, dan setidaknya 8 karakter atau lebih" required="">
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label for="inputHakAkses">Hak Akses</label>
                                            <input type="text" name="level" class="form-control" id="inputHakAkses" disabled="" value="<?php echo $_SESSION['level'] ?>">
                                        </div>
                                    </div>
                                    <button type="submit" name="update-akun" class="btn btn-primary">Update</button>
                                </form>
                            </div>
                        </div>
                    </div>
