...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/inputLainnya.css">
</head>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="inputLainnya.php">Lainnya</a>
                    </div>
                </div>
            </li>
            <!-- Divider -->
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Lainnya</h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-gray">Input Data Lainnya</h6>
                        </div>
                        <div class="card-body">
                            <form action="process-input-lainnya.php" method="POST">
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <label for="inputNoLap">Peraturan</label>
                                        <input type="text" name="peraturan" class="form-control" id="inputNoLap" required="" placeholder="Masukkan peraturan...">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputTglLap">Tentang</label>
                                        <input type="text" name="tentang" class="form-control" id="inputTglLap" required="" placeholder="Tentang...">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="inputSatuanKerja">Link</label>
                                    <input type="text" name="link" class="form-control" id="inputSatuanKerja" required="" placeholder="Masukkan link...">
                                </div>
                                <button type="submit" name="input-lainnya" class="btn btn-primary">Tambah</button>
                            </form>
                        </div>
                    </div>
                    <!-- Akhir Lainnya -->
