            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <!-- Page Heading -->
                        <h1 class="h3 mb-2 text-gray-800">Update Dokumen Lainnya</h1>
                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body"> 
                                <form action="process-update-lainnya.php" method="POST">
                                    <?php
                                        $id = $_GET['id'];
                                        $data = mysqli_query($koneksi, "SELECT * FROM dok_lainnya WHERE id='$id'");
                                        while($d = mysqli_fetch_array($data)){
                                    ?>
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <input type="hidden" name="id" value="<?php echo $d['id']; ?>">
                                            <label for="inputPeraturan">Peraturan</label>
                                            <input type="text" name="peraturan" class="form-control" id="inputPeraturan" value="<?php echo $d['peraturan']; ?>">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputTentang">Tentang</label>
                                            <input type="text" name="tentang" class="form-control" id="inputTentang" value="<?php echo $d['tentang']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-row">
